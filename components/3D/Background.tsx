...
export function Background({ scrollRef, currentSection }: BackgroundProps) {
  const heroGradient =
    "radial-gradient(circle at 50% 50%, rgb(10, 12, 20) 0%, rgb(0, 0, 0) 100%)";
  const blockchainGradient =
    "radial-gradient(circle at 50% 50%, #200a49ff 0%, #0f172a 100%)";
      ...
      >
        ...
        >
          <Suspense fallback={null}>
            ...
            <fog
              attach="fog"
              args={[currentSection === 1 ? "#2e1065" : "#000000", 10, 60]}
            />
